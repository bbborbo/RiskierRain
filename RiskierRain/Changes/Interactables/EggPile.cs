...
namespace RiskierRain.Interactables
{
    class EggPile : InteractableBase<EggPile>
    {
        ...
        public override GameObject interactableModel => RiskierRainPlugin.orangeAssetBundle.LoadAsset<GameObject>("Assets/Prefabs/eggPile.prefab");
        ...
        public override int normalWeight => 2000;
