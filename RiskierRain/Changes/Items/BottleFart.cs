...
namespace RiskierRain.Items
{
    class BottleFart : ItemBase<BottleFart>
    {
        ...
        public override GameObject ItemModel => RiskierRainPlugin.orangeAssetBundle.LoadAsset<GameObject>("Assets/Prefabs/voidBottle.prefab");

        public override Sprite ItemIcon => RiskierRainPlugin.orangeAssetBundle.LoadAsset<Sprite>("Assets/Icons/texIconPickupITEM_FARTBOTTLE.png");
