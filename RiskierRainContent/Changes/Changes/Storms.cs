...
using static RiskierRainContent.StormRunBehaviorController;
...
namespace RiskierRainContent
{
    public partial class RiskierRainContent : BaseUnityPlugin
    {
        ...
        private static void CreateStormsRunBehaviorPrefab()
        {
            ...
            CoreModules.Assets.networkedObjectPrefabs.Add(StormsRunBehaviorPrefab);
            CoreModules.Assets.entityStates.Add(typeof(StormController.IdleState));
            CoreModules.Assets.entityStates.Add(typeof(StormController.StormApproach));
            CoreModules.Assets.entityStates.Add(typeof(StormController.StormWarning));
            CoreModules.Assets.entityStates.Add(typeof(StormController.StormActive));
    ...
    public class StormRunBehaviorController : MonoBehaviour
    {
        ...
        public const float drizzleStormDelayMinutes = 8;
        public const float drizzleStormWarningMinutes = 2;
        public const float rainstormStormDelayMinutes = 6;
        public const float rainstormStormWarningMinutes = 1;
        public const float monsoonStormDelayMinutes = 3;
        ...
        private void Stage_BeginServer(On.RoR2.Stage.orig_BeginServer orig, Stage self)
        {
            orig(self);
            Debug.Log("A");
            GameObject stormControllerObject = Instantiate(RiskierRainContent.StormsControllerPrefab);
