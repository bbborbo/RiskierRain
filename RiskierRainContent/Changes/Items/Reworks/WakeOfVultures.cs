...
namespace RiskierRainContent.Items
{
    class WakeOfVultures : ItemBase<WakeOfVultures>
    {
        ...
        {
            ItemDef wakeItemDef = RiskierRainContent.RetierItem(nameof(RoR2Content.Items.HeadHunter), ItemTier.Boss);//Addressables.LoadAssetAsync<ItemDef>("RoR2/Base/HeadHunter/HeadHunter.asset").WaitForCompletion();
