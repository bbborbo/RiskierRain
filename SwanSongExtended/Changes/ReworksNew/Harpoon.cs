...
{
    public class Harpoon : ReworkBase<Harpoon>
    {
        public override string ItemPath => RoR2BepInExPack.GameAssetPaths.Version_1_39_0.RoR2_DLC1_MoveSpeedOnKill.MoveSpeedOnKill_asset;

        public override string ItemName => "Hunter\u2019s Harpoon";
