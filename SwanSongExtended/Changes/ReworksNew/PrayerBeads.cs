...
{
    public class PrayerBeads : ReworkBase<PrayerBeads>
    {
        [AutoConfig("Permanent Stat Bonus Percentage", 0.07f)]
        public static float beadsPermanentStatBonus = 0.07f;
        public override string ItemPath => RoR2BepInExPack.GameAssetPaths.Version_1_39_0.RoR2_DLC2_Items_ExtraStatsOnLevelUp.ExtraStatsOnLevelUp_asset;

        public override string ItemName => "Prayer Beads";
