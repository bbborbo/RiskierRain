...
{
    public class RejuvRack : ReworkBase<RejuvRack>
    {
        ...
        public override string ItemPath => RoR2BepInExPack.GameAssetPaths.Version_1_39_0.RoR2_Base_IncreaseHealing.IncreaseHealing_asset;
        ...
        public override string ItemFullDesc => 
            $"Healing past full will <style=cIsHealing>store the excess</style> in a <style=cIsHealing>healing reserve</style> at " +
        ...
        private void RejuvOverheal(ILContext il)
        {
            ...
            //void the original rejuv rack logic, we dont need it
            //c.GotoNext(MoveType.After,
