...
{
    public class ResonanceDisc : ReworkBase<ResonanceDisc>
    {
        ...
        static string damageDesc = "launches itself toward a target for <style=cIsDamage>300%</style> base damage <style=cStack>(+300% per stack)</style>, " +
        ...
        public override string ItemPath => RoR2BepInExPack.GameAssetPaths.Version_1_39_0.RoR2_Base_LaserTurbine.LaserTurbine_asset;

        public override string ItemName => "Resonance Disc";

        public override string ItemPickupDesc => "Obtain a Resonance Disc charged by killing enemies. Fires automatically when fully charged.";

        public override string ItemFullDesc => "Killing enemies charges the Resonance Disc. The disc " + damageDesc;
        ...
        public override void Hooks()
        {
            ...
            Hook q = new Hook(
                ...
                typeof(ResonanceDisc).GetMethod(nameof(ReflectOnThatThang), (BindingFlags)(-1))
            );
            Hook w = new Hook(
        ...
        public static void ReflectOnThatThang(orig_idc orig, RoR2.LaserTurbineController self) { }
