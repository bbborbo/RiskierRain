...
namespace SwanSongExtended.Elites
{
    class LeechingAspect : EliteEquipmentBase<LeechingAspect>
    {
        ...
        public override Sprite EliteBuffIcon => Addressables.LoadAssetAsync<Texture2D>("RoR2/Base/EliteHaunted/texBuffAffixHaunted.tif").WaitForCompletion().AsSprite();
        ...
        public override EliteTiers EliteTier { get; set; } = EliteTiers.Rare;
        ...
        private void CreatePulsePrefab()
        {
            ...
            Content.AddEntityState(typeof(LeechingHealNovaPulse));
